...
from app.models.user import existe_usuario
...
# Si el usuario existe y la contraseña es correcta, lo logueamos
        ...
        if user:
            ...
            flash("Credenciales incorrectas. Verifica tu email y contraseña ❌")
...
def register():
    if request.method == "POST":
        ...
        if existe_usuario(email):
            flash("Error: Este correo electrónico ya está registrado 🚫")
